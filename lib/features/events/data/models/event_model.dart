...
class EventModel extends Event {
  ...
  factory EventModel.fromFirestore(String id, Map<String, dynamic> json) {
    return EventModel(
      ...
      rainProb: (json['rainProb'] as num?)?.toInt(),
      weatherUpdatedAt: (json['weatherUpdatedAt'] as Timestamp?)?.toDate(),
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      if (weatherUpdatedAt != null)
        'weatherUpdatedAt': Timestamp.fromDate(weatherUpdatedAt!),
